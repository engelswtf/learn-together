      ...
      <header className="pt-8 pb-6 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center gap-4 mb-2">
            <div className="w-14 h-14 rounded-xl bg-pink-500 bg-opacity-20 dark:bg-opacity-30 flex items-center justify-center">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">First to answer wins</p>
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          {gameState === "lobby" && (
            <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-8 shadow-lg">
              <Lobby topicId={currentTopicId} gameMode="race" onRoomJoined={handleRoomJoined} />
            </div>
          )}
